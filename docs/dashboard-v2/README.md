...
- Standing GK/goalkeeper training uses the household's settled weekly coverage setup. Ordinary occurrences remain visible in the calendar but do not create kid-overlap flags or NOW/NEXT candidates; a cancellation, reschedule, move, or other explicit change remains eligible for NOW/NEXT.
