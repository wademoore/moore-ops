...
- Relay events (Women/Men Open, 4 entries) cannot be checked — no relay
  result data exists in either source file. Skip and note as unchecked
  in output, don't silently omit the note.
