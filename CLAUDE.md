...
**Plain `npm test`: 1181 tests / 1172 pass / 3 fail / 6 cancelled.** Freshly measured on
...
**Coder mode must keep plain `npm test` at 1181+ (1172 passing).**
