...
- **2022 Batches 1–2 complete; Batches 3–24 (2022–2025) not yet run** — `league-results-history-v2.json`: 7520 rows (1230 trial + 2688 batch 1 + 3602 batch 2). `relay-results-history-v2.json`: 171 rows (19 trial + 68 batch 1 + 84 batch 2). Meets skipped: 2022-06-13-glt-at-gs (no PDF). Batch 2 (2022-06-20, 9 meets): 1 row dropped in kw-at-gs (Haran Dillan — unmatched format with extra column between seed and official time).
