...
- **2022 Batches 1–3 complete; Batches 4–24 (2022–2025) not yet run** — `league-results-history-v2.json`: 10855 rows (1230 trial + 2688 batch 1 + 3602 batch 2 + 3335 batch 3). `relay-results-history-v2.json`: 249 rows (19 trial + 68 batch 1 + 84 batch 2 + 78 batch 3). Meets skipped: 2022-06-13-glt-at-gs (no PDF). Batch 2 (2022-06-20, 9 meets): 1 row dropped in kw-at-gs (Haran Dillan — unmatched format with extra column between seed and official time). Batch 3 (2022-06-27, 9 meets including 2022-06-28 makeup wc-at-kp): all clean; event gaps in ip-at-eh (event 22, no entries) and wgp-at-vw (events 1,5,6,21,23,43,45,46 — small roster) are genuine.
