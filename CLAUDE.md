...
- **2022 Batch 1 complete; Batches 2–24 (2022–2025) not yet run** — Batch 1 (2022-06-12 pre-season + 2022-06-13 openers, 9 meets including 1 pre-existing trial) parsed and committed. `league-results-history-v2.json`: 3918 rows (1230 trial + 2688 batch 1, after post-batch parser fixes recovered 2 previously-dropped parenthetical-name rows in eh-at-km). `relay-results-history-v2.json`: 87 rows (19 trial + 68 batch 1). 1 meet skipped: 2022-06-13-glt-at-gs (no PDF).
