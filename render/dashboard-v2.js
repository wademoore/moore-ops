...
const V2_LOGOS = {
  ...
  tribe: optionalAssetDataUrl('logo-wm-athletics.jpg'),
  wm: optionalAssetDataUrl('logo-wm-athletics.jpg'),
};
...
.ticker-slot[data-sports-org="wm"] .ticker-logo,.ticker-slot[data-sports-org="tribe"] .ticker-logo{object-fit:cover;border-radius:50%;background:#fff}
