...
function baseSnapshot() {
  return { version: 1, generatedAt: NOW.toISOString(), nextPollSeconds: 1800, slots: [
    ...
    slot('wm', 'W&M', event('w-next','wm','football','scheduled','2026-08-20T23:00:00Z',{ opponent:'Richmond Spiders', opponentAbbreviation:'RICH', records:{overall:'1-0',conference:'0-0'} }), { record:'1-0', records:{overall:'1-0',conference:'0-0',regularSeason:null,preseason:null}, conference:'Patriot', standing:'2nd Patriot' }),
...
try {
  ...
  for (const html of htmlPaths) {
    ...
    const valid = { schemaVersion:1, version:1, generatedAt:NOW.toISOString(), nextPollSeconds:1800, source:{stale:false,fromCache:false}, slots:['wm','tennessee','commanders','nationals'].map(validationSlot) };
